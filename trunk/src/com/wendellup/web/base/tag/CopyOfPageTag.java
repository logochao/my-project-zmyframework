...
public class CopyOfPageTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		if (currentPage != 1) {
			out.print("<a href='showAccountsByPage?currentPage=1'>首页</a>|");
			out.print("<a href='showAccountsByPage?currentPage="
					+ (currentPage - 1) + "'>上一页 </a> | ");
		}
		...
		if (currentPage == pages) {
			...
			out.print("<a href='showAccountsByPage?currentPage="
					+ (currentPage + 1) + "'>下一页 </a> | ");
			out.print("<a href='showAccountsByPage?currentPage=" + pages
					+ "'>尾页</a>|");
		}
	}
}
